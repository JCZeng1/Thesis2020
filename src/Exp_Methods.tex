...
%%%Data15-16 is reprocessed with rel.21 framework (tag r9264), data17 with r10258 and data18 with f937; 
%%%reference to the full data containers is here: 
%%%\mbox{\href{https://its.cern.ch/jira/projects/ATLASDPD/issues/ATLASDPD-1521}{data derivation production link}}
%%%
...
%For each sample, we include all purely-electroweak tree-level diagrams of order $\mathcal{O}(\alpha_{EW}^6)$ that contribute to the final state:
%\begin{itemize}
%  \item Vector Boson Scattering (VBS) diagrams, as shown in examples in Fig.~\ref{fig:feynmanVBS};
%  \item Non-VBS electroweak diagrams excluding $b$-quarks in the initial and final states, with examples in Fig.~\ref{fig:feynmanEWKnonVBS} (a)--(d);
%  \item Non-VBS electroweak diagrams including $b$-quarks in the initial or final states, with examples in Fig.~\ref{fig:feynmanEWKnonVBS} (e)--(f).
%\end{itemize}
...
%The dashed line represents the Higgs boson; while the solid lines represent quarks and the rippled ones the vector bosons.  
%These and other Feynman diagrams in this note are made
...
%\caption{
%Examples of non-VBS $\mathcal{O}(\alpha_{EW}^6)$ diagrams that contribute to the signal. 
%The dashed line represents the Higgs boson; while the solid lines represent quarks and the rippled ones the vector bosons.
%The decays of the bosons are not
...
%  \centering
%  \subfloat[]{
%   \includegraphics[width=0.45\textwidth]{figures/aQGC/decomp/aQGC_decomp_1} \qquad
%  }
%  \subfloat[]{
%    \includegraphics[width=0.45\textwidth]{figures/aQGC/decomp/aQGC_decomp_2}
%  }
%  \caption{
%    Closure of piece-wise generator with respect to full simultaneous generation 
%    on the invariant mass distribution of the diboson;
%    one-term comparison for operator FT0 (c.f. green and purple) (left)
%    and cross-term comparison for FT0,FT1 (c.f. yellow and purple) (right).
%  }
%  \label{fig:aQGC_decomp}
%  \end{figure}
...
%%%The details of CxAOD framework is found in \mbox{\href{https://twiki.cern.ch/twiki/bin/view/AtlasProtected/CxAODFramework}{TWiki}} or README at:
%%%\begin{itemize}
%%%\item \url{https://gitlab.cern.ch/CxAODFramework/CxAODBootstrap_VHbb/tree/master},
%%%\item \url{https://gitlab.cern.ch/CxAODFramework/CxAODMakerCore}.
%%%\end{itemize}
