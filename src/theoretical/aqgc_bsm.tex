...
%%%Using a low-energy effective theory, BSM physics can be parameterized and incorporated into the VBS process without committing to a specific BSM theory. This approach suits analyses in which no resonance is predicated or is expected at a high energy scale that can't be observed directly. 
%%%
%%%In the effective theory framework, aQGCs can modify the VBS and typically enhance its cross-section at high energy.
%%%The VBS process is highly sensitive to the quartic-gauge coupling vertices of the SM.
%%%
%%%%%%%
%%%
