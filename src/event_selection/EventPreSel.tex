...
Table~\ref{tab:presel_CxAOD} details the selection cuts implemented within the CxAOD framework, specifically designed to optimize data management by significantly reducing the data size. All CP recommendations, provided by the Combined Performance (CP) groups for analysis use, are already applied at this stage.
