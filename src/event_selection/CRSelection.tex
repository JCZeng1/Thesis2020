...
\begin{figure}[ht]
    \centering
    \subfigure[\emph{\zlep, resolved VCR}]{\includegraphics[width=0.3\textwidth]{figures/0lep/cutflow/nominal/merged/plots/individual_SRVBS_Res_MVHadRes_MVHadRes_cutflow.pdf}}
    \subfigure[\emph{\olep, resolved WCR}]{\includegraphics[width=0.3\textwidth]{figures/1lep/CRPlots/C_0ptag2pjet_0ptv_CRVjet_MVHadRes_Lin.png}}
    \subfigure[\emph{\tlep, resolved ZCR}]{\includegraphics[width=0.3\textwidth]{figures/2lep/dataMC/C_0ptag2pjet_0ptv_CRVjet_MVHadRes_Log.png}}
    \caption{ $m_{jj}$ plot in the sidebands in \zlep channel VCR (a), in \olep WCR (b) and \tlep channel ZCR (right).
    In particular, the \zlep plot shows the distribution without the low 50 GeV cut applied.} 
    \label{fig:1lep2lepMVHadResCR}
\end{figure}

\begin{figure}[ht]
    \centering
    \subfigure[\emph{\tlep, merged ZCR}]{\includegraphics[width=0.45\textwidth]{figures/2lep/dataMC/C_0ptag1pfat0pjet_0ptv_CRVjet_fatJetMass_Log.eps}}
    \caption{ $m_{J}$ plot in \tlep channel ZCR. Merged control region uses the Fail-80\% tagger WP region.}
    \label{fig:1lep2lepMVHadMerCR}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \subfigure[After merged preselection]{\includegraphics[width=0.3\textwidth]{figures/1lep/CRPlots/C_0ptag0pjet_0ptv_Presel_Merged_NBJets_Lin.png}}
    \subfigure[After resolved preselection]{\includegraphics[width=0.3\textwidth]{figures/1lep/CRPlots/C_0ptag0pjet_0ptv_Presel_Resolved_NBJets_Lin.png}}
