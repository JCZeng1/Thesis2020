...
\begin{figure}[htbp]
  ...
  \caption{Cutflows for 1-lepton event selection, where events can qualify for multiple regions without priority—except in the analysis phase, where merged regions take precedence over resolved ones. 'Preselection' refers to events with a single lepton having $p_T > 28$ GeV and meeting trigger criteria.}
...
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqSR50.tex}}
%%%        \caption{SR High Purity Merged}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqSR80.tex}}
%%%        \caption{SR Low Purity Merged}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqSRRes.tex}}
%%%        \caption{SR Resolved}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqCRTop50.tex}}
%%%        \caption{TopCR High Purity Merged}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqCRTop80.tex}}
%%%        \caption{TopCR Low Purity Merged}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqCRTopRes.tex}}
%%%        \caption{TopCR Resolved}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqCRVjetsMer.tex}}
%%%        \caption{WjetsCR Merged}
%%%    \end{subfigure}
%%%    \begin{subfigure}{\textwidth}
%%%        \resizebox{\textwidth}{!}{\input{figures/1lep/cutflow/Cutflow1Lep_CutsSeqCRVjetsRes.tex}}
%%%        \caption{WjetsCR Resolved}
%%%    \end{subfigure}
