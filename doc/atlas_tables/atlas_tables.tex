...
As of Version 04-00-00 of \Package{atlaslatex} the default value is set to 5.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lS[table-format=5.2]}
    ...
    Value2 & 98765.43
  \end{tabular}
  % \caption{A table with \Option{group-minimum-digits=4}.}
  ...
  \begin{tabular}{lS[table-format=5.2]}
    ...
    Value2 & 98765.43
  \end{tabular}
  % \caption{A table with \Option{group-minimum-digits=5}.}
