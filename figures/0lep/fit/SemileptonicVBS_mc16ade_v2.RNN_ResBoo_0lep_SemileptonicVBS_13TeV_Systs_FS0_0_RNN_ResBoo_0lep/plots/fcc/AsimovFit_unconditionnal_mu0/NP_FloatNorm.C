...
//=========  (Sat Mar 26 05:54:16 2022) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph_reduced_reduced22 = new TH1F("Graph_Graph_reduced_reduced22","Graph",276,0,151.8);
   ...
   TH1F *Graph_Graph_reduced_reduced23 = new TH1F("Graph_Graph_reduced_reduced23","Graph",276,0,151.8);
   ...
   Graph_Graph_reduced_reduced24->SetMinimum(-0.0002349922);
   Graph_Graph_reduced_reduced24->SetMaximum(0.0004064486);
