...
//=========  (Sat Mar 26 05:53:14 2022) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph_reduced_reduced7 = new TH1F("Graph_Graph_reduced_reduced7","Graph",276,0,151.8);
   ...
   TH1F *Graph_Graph_reduced_reduced8 = new TH1F("Graph_Graph_reduced_reduced8","Graph",276,0,151.8);
   ...
   Graph_Graph_reduced_reduced9->SetMinimum(-0.0001779118);
   Graph_Graph_reduced_reduced9->SetMaximum(0.0001189513);
