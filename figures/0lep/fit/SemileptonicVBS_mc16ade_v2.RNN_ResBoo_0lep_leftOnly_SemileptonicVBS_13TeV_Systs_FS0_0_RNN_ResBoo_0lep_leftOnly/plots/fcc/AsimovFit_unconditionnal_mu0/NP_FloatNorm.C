...
//=========  (Mon Mar 28 09:48:51 2022) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph_reduced_reduced52 = new TH1F("Graph_Graph_reduced_reduced52","Graph",200,0,110);
   ...
   TH1F *Graph_Graph_reduced_reduced53 = new TH1F("Graph_Graph_reduced_reduced53","Graph",200,0,110);
   ...
   Graph_Graph_reduced_reduced54->SetMinimum(-0.0003492116);
   Graph_Graph_reduced_reduced54->SetMaximum(0.0004286361);
