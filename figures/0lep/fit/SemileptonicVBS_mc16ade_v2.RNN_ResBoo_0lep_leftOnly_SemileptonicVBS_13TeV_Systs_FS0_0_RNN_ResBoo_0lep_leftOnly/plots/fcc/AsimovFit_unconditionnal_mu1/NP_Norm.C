...
//=========  (Mon Mar 28 09:48:14 2022) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph_reduced_reduced40 = new TH1F("Graph_Graph_reduced_reduced40","Graph",200,0,110);
   ...
   TH1F *Graph_Graph_reduced_reduced41 = new TH1F("Graph_Graph_reduced_reduced41","Graph",200,0,110);
   ...
   Graph_Graph_reduced_reduced42->SetMinimum(-0.0002811562);
   Graph_Graph_reduced_reduced42->SetMaximum(0.0002584961);
