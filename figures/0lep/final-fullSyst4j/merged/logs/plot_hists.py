...
# SRs
regions += ['0ptag1pfat0pjet_0ptv_SRVBS_HP', '0ptag1pfat0pjet_0ptv_SRVBS_LP', '0ptag2pjet_0ptv_SRVBS_Fid']
...
def make_plot(prefix, region_name, variable, stack_main, contours_main, hists_ratio, hist_dat, hists_soverb, hist_dat_extra = None, do_ratio_fit = False, altovernom_margin = 2.5, ratio_margin = .45, cutflow_hists = None, th2 = False, wide_legend = False):
