...
#               ['cutflowraw'                               , ''                               , None     , 'r'       , None        , 100        , False      , False                        , False, []],
               # individual cutflow hists (note: cannot be used with any other variables!)
                ...
                ['SRVBS_LP_MET_MET'                            , 'E_{T}^{miss} [GeV]'               , 2     , 'r'       , None        , None        , False      , False                        , False, [200.]],
                ...
                ['SRVBS_LP_TrkMET_TrkMET'                         , 'E_{T}^{miss,track} [GeV]'         , None     , 'r'       , None        , None        , False      , False                        , False, [50.]],
                ...
                ['SRVBS_LP_PtTagMerJet1_PtTagMerJet1'                   , 'p_{T}(j^{tag}_{lead}) [GeV]'      , 5     , 'r'       , None        , None        , False      , False                        , False, [30.]],
                ['SRVBS_HP_PtTagMerJet2_PtTagMerJet2'                   , 'p_{T}(j^{tag}_{sublead}) [GeV]'      , 5     , 'r'       , None        , None        , False      , False                        , False, [30.]],
                ['SRVBS_LP_PtTagMerJet2_PtTagMerJet2'                   , 'p_{T}(j^{tag}_{sublead}) [GeV]'      , 5     , 'r'       , None        , None        , False      , False                        , False, [30.]],
                ['SRVBS_Res_PtTagResJet1_PtTagResJet1'                   , 'p_{T}(j^{tag}_{lead}) [GeV]'      , 5     , 'r'       , None        , None        , False      , False                        , False, [30.]],
                ['SRVBS_Res_PtTagResJet2_PtTagResJet2'                   , 'p_{T}(j^{tag}_{sublead}) [GeV]'      , 5     , 'r'       , None        , None        , False      , False                        , False, [30.]],
                ...
                ['SRVBS_LP_DPhiMETTrkMET_DeltaPhiMetTrkMet'                  , '|#Delta#Phi(E_{T}^{miss}, E_{T}^{miss,track})|'         , None     , 'r'       , None        , None        , False      , False                        , False, [math.pi/2.]],
                ...
                ['SRVBS_LP_MinDPhiSmallRJets_MinDPhiSmallRJets'             , 'min|#Delta#Phi(E_{T}^{miss}, j^{any})|'         , None     , 'r'       , None        , None        , False      , False                        , False, [math.pi/6.]],
                ...
                ['SRVBS_LP_MinDPhiFatJet_MinDPhiFatJet'                 , '|#Delta#Phi(E_{T}^{miss}, J^{sig})|'         , None     , 'l'       , None        , None        , False      , False                        , False, [math.pi/9.]],
                ['SRVBS_Res_MVHadRes_MVHadRes'                         , 'm(jj)^{sig} [GeV]'     , 2     , 'r'       ,64,106, False      , False                     , False, [64, 106]],
                ['SRVBS_HP_MFatJetLow_MFatJet'                         , 'm(J^{sig}) [GeV]'     , 2     , 'r'       ,50,150, False      , False                     , False, [50]],
                ['SRVBS_LP_MFatJetLow_MFatJet'                         , 'm(J^{sig}) [GeV]'     , 2     , 'r'       ,50,150, False      , False                     , False, [50]],
                ...
                ['SRVBS_HP_D2FatJetHP_MFatJet'                     , 'm(J^{sig}) [GeV]'      , 10     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_D2FatJetLP_MFatJet'                     , 'm(J^{sig}) [GeV]'      , 10     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_D2FatJetHP_D2FatJet'                     , 'D_{2}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_D2FatJetLP_D2FatJet'                     , 'D_{2}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_D2FatJetHP_NtrkFatJet'                     , 'N_{track}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_D2FatJetLP_NtrkFatJet'                     , 'N_{track}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_D2FatJetHP_PtFatJet'                     , 'p_{T}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_D2FatJetLP_PtFatJet'                     , 'p_{T}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_TaggerFatJetHP_MFatJet'                     , 'm(J^{sig}) [GeV]'      , 10     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_TaggerFatJetHP_D2FatJet'                     , 'D_{2}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_TaggerFatJetHP_NtrkFatJet'                     , 'N_{track}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_HP_TaggerFatJetHP_PtFatJet'                     , 'p_{T}(J^{sig})'      , 4     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_TaggerFatJetLP_MFatJet'                     , 'm(J^{sig}) [GeV]'      , 10     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_TaggerFatJetLP_D2FatJet'                     , 'D_{2}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_TaggerFatJetLP_NtrkFatJet'                     , 'N_{track}(J^{sig})'      , None     , 'r'       ,None,None, False      , False                        , False, []],
                ['SRVBS_LP_TaggerFatJetLP_PtFatJet'                     , 'p_{T}(J^{sig})'      , 4     , 'r'       ,None,None, False      , False                        , False, []],
#               # q/g fractions
...
def make_plot(prefix, region_name, variable, stack_main, contours_main, hists_ratio, hist_dat, hists_soverb, hist_dat_extra = None, do_ratio_fit = False, altovernom_margin = 2., ratio_margin = .45, cutflow_hists = None, th2 = False, wide_legend = False):
  ...
  if stack_main != None or len(contours_main) > 0 or len(hists_ratio) > 0 or hist_dat != None and False:
    ...
    if stack_main != None:
      ...
      for hst in stack_main.GetHists():
        if not 'rejected' in hst.GetName():
          legend_main.AddEntry(hst, manipulate_legend_name(hst.GetName()).replace('accepted ', ''), 'f')
    ...
    if hist_dat != None:
     if 'TH1' in str(type(hist_dat)):
       legend_main.AddEntry(hist_dat, hist_dat.GetName().replace('rejected_data', 'rejected data').replace('accepted_data', 'accepted data'))
     elif 'THStack' in str(type(hist_dat)):
       for hst in hist_dat.GetHists(): legend_main.AddEntry(hst, hst.GetName().replace('rejected_data', 'rejected data').replace('accepted_data', 'accepted data'))
    ...
    if stack_main != None:
      ...
      if 'TaggerFatJet' in variable[0]:
        if 'THStack' in str(type(hist_dat)):
          hsts = [hst for hst in hist_dat.GetHists()]
          hsts[1].Add(hsts[0])
          hsts[0].Draw('same')
          hsts[1].Draw('same')
      else:
      ...
      hsts = [hist for hist in contours_main]
      
      if 'TaggerFatJet' in variable[0]: hsts[1].Add(hsts[0])

      hsts[0].SetLineWidth(int(4))
      hsts[1].SetLineWidth(int(4))

      hsts[0].Draw('hist same')
      hsts[1].Draw('hist same')
