...
#                       "FATJET_BJT_JET_JetTagSF_Dijet_Modelling__1up": [ROOT.kOrange, 'dijet modelling 1up'],
#                       "FATJET_BJT_JET_JetTagSF_Dijet_Modelling__1down": ROOT.kOrange,
#                       "FATJET_BJT_JET_JetTagSF_Gammajet_Modelling__1up": [ROOT.kCyan, 'gamma jet modelling 1up'],
#                       "FATJET_BJT_JET_JetTagSF_Gammajet_Modelling__1down": ROOT.kCyan,
#                       "FATJET_BJT_JET_JetTagSF_Hadronisation__1up": [ROOT.kViolet, 'hadronization 1up'],
#                       "FATJET_BJT_JET_JetTagSF_Hadronisation__1down": ROOT.kViolet,
#                       "FATJET_BJT_JET_JetTagSF_Radiation__1up": [ROOT.kYellow, 'radiation 1up'],
#                       "FATJET_BJT_JET_JetTagSF_Radiation__1down": ROOT.kYellow,
...
#                       "MUR1_MUF1_PDF269000": [ROOT.kGreen, 'alpha_s 0117 1down'],
#                       "MUR1_MUF1_PDF270000": [ROOT.kGreen, 'alpha_s 0119 1up'],
#                      }
#                     ),
#                     (
#                      'internalpdfZ',
...
#                     ),
                     ...
                     (
                      ...
                      ['ttbar_nom'],
                      {
                       "TheoryISR_ttbar__1up": [ROOT.kRed, 'ISR 1up'],
                       "TheoryISR_ttbar__1down": ROOT.kRed,
                      }
                     ),
                     (
                      'isrStop',
                      ['stop'],
                      {
                       "TheoryISR_stop__1up": [ROOT.kRed, 'ISR 1up'],
                       "TheoryISR_stop__1down": ROOT.kRed,
                      }
                     ),
                    ]+[
#                     (
  ...
  for region_specification in regions:
    ...
    for variable in variables:
      ...
      if get_systematics:
        ...
        syst_contours_max = new_contour.GetMaximum() * 1.5
...
#         new_ratio.GetYaxis().SetNdivisions(5)
         ...
         if 'internalpdf' in syst_name or 'vtag' in syst_name:
           new_ratio.SetMaximum(1.2)
           new_ratio.SetMinimum(.2)
         elif 'qcdscale' in syst_name:
           new_ratio.SetMaximum(1.5)
           new_ratio.SetMinimum(.5)
         else:
           new_ratio.SetMaximum(1.5)
           new_ratio.SetMinimum(.5)
